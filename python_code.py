...
██╔╝░░░╚██████╔╝██║░╚███║██║╚█████╔╝██████╔╝██╔╝░░░
╚═╝░░░░░╚═════╝░╚═╝░░╚══╝╚═╝░╚════╝░╚═════╝░╚═╝░░░░
                      https://github.com/uniosteam/''')

cap = cv2.VideoCapture(0) # Выбор порта вебкамеры (если не запускается, попробуйте сменить цифру)
serial = serial.Serial('/dev/ttyACM0', 9600) # Данные для работы serial. Порт и скорость. Если не работает, то меняйте порт

cap.set(3, 640) # Разрешение видео (ширина в px)
cap.set(4, 480) # Разрешение видео (высота в px)
